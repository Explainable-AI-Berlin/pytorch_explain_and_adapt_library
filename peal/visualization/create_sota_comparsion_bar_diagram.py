...
titles = ['Square', 'Smiling vs Copyrighttag', 'Young vs Smiling', 'Blond vs Male', 'Follicles']
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728']

fig, axs = plt.subplots(1, 5, figsize=(25, 4))  # Reduced height from 6 to 4
...
fig.legend(legend_elements, labels, loc='upper center', bbox_to_anchor=(0.5, 1.05),
           ncol=4, title="Global Color Legend", fontsize=8, title_fontsize=10)
