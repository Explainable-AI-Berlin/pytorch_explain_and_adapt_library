...
def merge_feedback(feedback_list):
    feedback_merged = {}
    feedback_merged["selectedDataPointIndices"] = feedback_list[0][
        "selectedDataPointIndices"
    ]
    for feedback in feedback_list[1:]:
        feedback_merged["selectedDataPointIndices"] = list(
            set(feedback_merged["selectedDataPointIndices"]).union(
                set(feedback["selectedDataPointIndices"])
            )
        )
