...
from peal.dependencies.matryoshka_sae.config import get_default_cfg, post_init_cfg


class MatryoshkaSAEConfig(SparseDictionaryConfig):
    n_components: Union[int, None] = 100
    sparse_dictionary_type: str = 'MatryoshkaSAE'
    ending: str = '.npz'
    cfg: dict = {}
...
class MatryoshkaSAE(SparseDictionary):
    def __init__(self, config=MatryoshkaSAEConfig()):
        ...
        self.config.cfg["aux_penalty"] = (1/32)
        ...
        self.config.cfg['act_size'] = 512 #2304
    ...
    def load_from_disk(self, path):
        ...
        self.sae.W_enc = checkpoint['W_enc']
        self.sae.W_dec = checkpoint['W_dec']
