...
def arguments():
    ...
    parser.add_argument('--gpu', default='0', type=str,
                        help='GPU id')
    parser.add_argument('--exp-name', default='fastdime', type=str,
                        help='Experiment Name')
    parser.add_argument('--output-path',default='/scratch/ppar/results', type=str,
                        help='Results Path')
    parser.add_argument('--weights-path', default='/scratch/ppar/models/classifier.pth', type=str,
                        help='Classification model weights')
    parser.add_argument('--dataset', default='CelebA', type=str,)
    parser.add_argument('--batch-size', default=10, type=int,
                        help='Batch size')
    parser.add_argument('--query-label', default=31, type=int)
