...
@torch.no_grad()
def compute_MNAC(oracle, path, exp_name):
...
if __name__ == "__main__":
    ...
    oracle = OracleMetrics(weights_path=ORACLEPATH, device=device)
    oracle.eval()
    A = 0

    results = compute_MNAC(oracle, args.output_path, args.exp_name)
