...
# # DATASET
# MODEL_FLAGS="--attention_resolutions 16,8 --class_cond False --diffusion_steps 1000 --learn_sigma False --noise_schedule linear --num_channels 128 --num_heads 4 --num_res_blocks 2 --resblock_updown True --use_fp16 True --use_scale_shift_norm True"
...
apptainer run \
    ...
    python main_regression_retinaMNIST.py $MODEL_FLAGS \
