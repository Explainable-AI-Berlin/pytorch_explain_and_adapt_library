...
# run DFR
python train_predictor.py --config "<PEAL_BASE>/configs/didae_experiments/predictors/square1k_foundation_linear_poisoned098_dfr.yaml"
...
# run GroupDRO
python run_adaptor.py --config "<PEAL_BASE>/configs/didae_experiments/adaptors/square_1k_foundation_linear_poisoned098_group_dro.yaml"
...
# run DiME-CFKD
python run_cfkd.py --config "<PEAL_BASE>/configs/didae_experiments/adaptors/square1000x098_dime_cfkd.yaml"
# run ACE-CFKD
python run_cfkd.py --config "<PEAL_BASE>/configs/didae_experiments/adaptors/square1000x098_ace_cfkd.yaml"
# run FastDiME-CFKD
...
# run DFR
python train_predictor.py --config "<PEAL_BASE>/configs/didae_experiments/predictors/celeba1k_foundation_linear_poisoned098_dfr.yaml"
python evaluate_predictor.py --model_path $PEAL_RUNS/celeba1k/Blond_Hair/openclip_linear_poisoned098/dfr/model.cpl --data_config configs/cfkd_experiments/data/celeba.yaml --model_config configs/didae_experiments/predictors/celeba1k_Blond_Hair_openclip_linear_poisoned098.yaml
# run GroupDRO
python run_adaptor.py --config "<PEAL_BASE>/configs/didae_experiments/adaptors/celeba_1k_foundation_linear_poisoned098_group_dro.yaml"
