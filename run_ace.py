...
def create_args():
    defaults = dict(
        ...
        dist_schedule="none",
        # filtering args
        # fraction of noise steps (e.g. 0.1 for 1000 smpling steps would be 100 out of 1000)
        ...
        # Target Dataset (ImageNet, CelebA, CelebAMV, CelebAHQ, BDDOIA and BDD100k available)
        dataset="ImageNet",
